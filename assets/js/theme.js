function start(jQuery$1){
  ...
  var mrCountdown = function ($) {
    ...
    var Default = {
      ...
      MINS_FMT: '%M',
      S_FMT: '%S',
      Y_LABEL_FMT: '%!Y:Ano,Anos;',
      MTHS_LABEL_FMT: '%!m:Mês,Meses;',
      W_LABEL_FMT: '%!w:Semana,Semanas;',
      D_LABEL_FMT: '%!d:Dia,Dias;',
      H_LABEL_FMT: '%!H:Hora,Horas;',
      MINS_LABEL_FMT: '%!M:Minuto,Minutos;',
      S_LABEL_FMT: '%!S:Segundo,Segundos;'
    };
    var CSS = {
      D_NONE: 'd-none'
    };
